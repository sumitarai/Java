...
public class Customer {
		...
		public static String createNewCustomer(ChromeDriver driver) throws InterruptedException{
			...
			Thread.sleep(2000); 
				...
				if(custLookupPage.equals("Customer Lookup")){
					...
					//Create new Acct		
					WebElement newAcct = driver.findElement(By.xpath(".//*[@id='ctl00_ctl00_btnNew']"));   //Click New from Customer Lookup page
					newAcct.click();
					...
					ReadExcelFile custNameandAdd = new ReadExcelFile("C:\\Work\\Java\\Selenium_TestDemo\\Resource\\SetupExcel.xlsx");
					...
					//assert if this opens new customer account page					
						...
						if (expectedDataStatus.equals(actualDataStatus)){
							...
							custSAPNumber = driver.findElement(By.xpath(".//*[@id='txtSAPCustomerNumber_contentTextBox_Display']")).getText();
							System.out.println("Customer.createNewCustomer - Customer Number: " + custSAPNumber);
							logger.info("Customer Number: " + custSAPNumber);
	...
	//This method will allow to Lookup Customer 
		 public static ChromeDriver findCustomer(ChromeDriver driver, String custSAPNumber) throws InterruptedException{
			...
			driver.findElement(By.xpath(".//*[@id='ctl00_ctl00_btnMainMenu']/img")).click();   // Clicked Main menu to reset 
			WebElement custLookup = driver.findElement(By.linkText("Customer Lookup"));  // Click the customer lookup link
			custLookup.click();
			...
			try {
				...
				custNumber.sendKeys(custSAPNumber); // input customer number
			
				driver.findElement(By.xpath(".//*[@id='submitSearch_slideBtnLink']")).click();  // Click search button
				System.out.println("It is displaying Customer Lookup results");
				Thread.sleep(2000);
				...
				Thread.sleep(2000);
					...
					System.out.println("Customer.findCustomer - Error encountered: " + e);
				}			
		return driver;
